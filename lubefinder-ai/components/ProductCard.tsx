...
export const ProductCard: React.FC<ProductCardProps> = ({ data, label, variant = 'neutral' }) => {
  const isQ8 = variant === 'q8';
  const isNotFound = data.productName === 'NON TROVATO';

  // Configurazione base dei temi
  let theme = isQ8 ? {
        ...
        {isNotFound ? (
          <div className="flex flex-col items-center justify-center h-full text-center py-8">
            ...
            <p className="text-slate-600 font-medium">
              Non è stato possibile trovare un corrispondente Q8 diretto o il prodotto cercato non è stato riconosciuto.
            </p>
          </div>
        ) : (
          <>
