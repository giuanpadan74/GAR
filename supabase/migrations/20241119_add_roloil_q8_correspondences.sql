-- Migrazione: Aggiungi corrispondenze Roloil-Q8 simmetriche
-- Questa migrazione crea record Roloil-Q8 per ogni combinazione unica
-- roloil-sae-type, trattando Q8 come riferimento principale
...
-- Inserisci i record mancanti per Roloil
INSERT INTO correspondences (brand, product, sae, roloil, q8, type, created_at, updated_at)
SELECT 
  'Roloil' as brand,
  qr.q8_reference as product,  -- Usa Q8 come prodotto Roloil
  qr.sae,
  qr.roloil,
  qr.q8_reference as q8,  -- Mantieni coerenza
  qr.type,
  NOW() as created_at,
  NOW() as updated_at
...
-- Aggiorna i record Roloil esistenti con valori Q8 dove mancano
